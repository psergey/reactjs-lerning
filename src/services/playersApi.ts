...
import { Languages, PopularPlayer, Profile } from "../models/models";
...
const PlayersProvider = {
    getPorfile: async (username: string): Promise<Profile> => {
    ...
    populars: async (language: Languages): Promise<PopularPlayer[]> => {
